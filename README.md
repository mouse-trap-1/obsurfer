...
This guide covers how to get around the app. It's based on the app's shell and routing logic; the exact fields and options inside each individual screen aren't covered here.
